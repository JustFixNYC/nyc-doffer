...
// Adapted from the 240 1ST AVE. (BBL 1009720001) SOA from June 5, 2019.
...
const MULTI_RENTSTAB_TOTAL = 96 + 95 + 105 + 105; // excludes last duplicate charge (repeat fee ID)
...
describe('extractRentStabilizedUnits()', () => {
  ...
  it(`should combine multiple unique (fee ID) rent stab charges into a single unit count`, () => {
